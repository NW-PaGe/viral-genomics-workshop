...
In March upon the closing of the Safari Zone, hospitals began seeing a large increase of cases that exceeded their capacity for testing and treatment. All cases were tested for flu, but a large proportion of cases returned negative. The most doctors could do was send patients home with treatment unless it was a severe case that required hospitalization. Although it was difficult to ascertain the number of true cases in January, but hospitals were now reporting cases in the thousands. 
