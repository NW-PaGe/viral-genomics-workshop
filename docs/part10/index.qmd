...
![Note that this 19-base example simplifies real-world genomics. Typical viral genomes are thousands of bases long, providing more resolution](../images/sequences_alignment.jpeg)
...
```{=html}
<div style="background:#E3F2FD; padding:12px; border-left:4px solid #2196F3; margin:16px 0;">
