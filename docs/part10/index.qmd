...
[Click to view annotations for the example tree!](../images/example_tree_nextstrain.jpg)
...
As mentioned, **SeqC** and **SeqD** share a common ancestory and form a monophyletic clade. SeqC diverges to ~0.13 substitutions per site, and SeqD slightly further to ~0.175 substitutions per site, indicating that SeqD has acquired more mutations than SeqC.

**SeqE** and **SeqF** can be interpreted similarly to how SeqC and SeqD are interpreted; with SeqE and SeqF sharing a common ancestor, and also forming their own monophyletic clade. 
