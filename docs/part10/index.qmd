...
The tree is **rooted at the reference genome (Ref)**, which gives direction to the branches and helps orient ancestral relationships. This means all other sequences are interpreted relative to it. **SeqA** is genetically identical to **Ref**, indicated by both appearing at a divergence of 0.00.
