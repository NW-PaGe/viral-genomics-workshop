...
| **Outgroup**        | A sequence (or set of sequences) known to fall outside the main group of interest. Outgroups are used to root trees and to provide evolutionary context.    | ““A virus that’s related but not part of the outbreak — we use it to figure out where the tree should start and how the others evolved”             | You want to orient the tree's root, or distinguish between ingroup and outgroup sequences for comparative analysis            |
