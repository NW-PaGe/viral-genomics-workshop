...
[Open Timeline in New Window](../images/timeline_genomic_analysis.JPEG)
...
A. Based on the phylogenetic tree, what can you infer about the relationships between the samples? Are there any distinct clusters or outliers?

B. Does the tree structure align with the exposure map? Are the spatial and genomic patterns consistent with one another, or do you notice any discrepancies?

C. When comparing the heatmap (pairwise SNP distances) to the tree, do any clusters or distance patterns reinforce the phylogenetic relationships you observed?

D. Taking all three data sources into account, what conclusions can you draw about transmission dynamics or potential sources? Does this analysis support or challenge your earlier hypothesis?
