...
<form id="quiz">
    <label for="question1">The sequencing results from early human and animal samples return with multiple species detected. What should scientists look for first?</label><br>
