---
title: "Samples Collected for Sequencing"
format: html
---
...
<form id="quiz">
    <label for="question1">What should scientists look for first when sequencing samples taken from humans and animals?</label><br>
