...
## Regional Lab Capacity and Sample Selection
...
&nbsp;&nbsp;&nbsp; - **Data formatting and visualization**, which prepares outputs such as sequence alignments, distance matrices, and trees that can be analyzed by epidemiologists.
