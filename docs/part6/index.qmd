...
2. Spike (S): mediates viral entry into host cells. Due to its interaction with the host cell, the spike protein is often a mutation target during evolution.
